...
CREATE TABLE domicilio (
  ...
  origen_despacho VARCHAR(255) DEFAULT 'Centro de Distribución OilSkin - Colegio Técnico José Félix Restrepo, Bogotá',
  lat_entrega DECIMAL(10, 7) NULL,
  lng_entrega DECIMAL(10, 7) NULL,
  lat_origen DECIMAL(10, 7) DEFAULT 4.57409,
  lng_origen DECIMAL(10, 7) DEFAULT -74.08958,
